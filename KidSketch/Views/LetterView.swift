...
//        
//        // 🕒 Move to the next letter after 1 second
...
//        var hasRecognizedLetter = false  // Prevent multiple detections
//
...
//
//                if detectedText.count == 1 && !self.hasRecognizedLetter {
//                    self.hasRecognizedLetter = true  // Prevent multiple recognitions
//
//                    DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
...
//                parent.text = "" // Clear input to prevent multiple detections
//                parent.onComplete()
//            } else {
//                self.hasRecognizedLetter = false // Reset if incorrect
//            }
//        }
//
